...
class RobotHeap {
  ...
  public static void main (String[] args) {
    ...
    String fooA = "C3PO";
    String fooB = "C3PO";
    String fooC = new String("C3PO");//Instantiated a new memory location in heap
    out.println(fooA==fooB);/*true, Compiler references fooA and fooB to same memory
                              location hence they are the same*/
